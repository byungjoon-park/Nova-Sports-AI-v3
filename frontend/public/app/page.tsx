...
const copy = {
  ko: {
    ...
    insight: "AI 인사이트", performanceLabel: "퍼포먼스", trend: "퍼포먼스 추이", last7: "최근 7일", last30: "최근 30일", last90: "최근 90일", training: "훈련", schedule: "오늘의 일정", viewAll: "전체 보기", activity: "활동", recent: "최근 활동", viewActivity: "모든 활동 보기 →",
  ...
  en: {
    ...
    insight: "AI Insight", performanceLabel: "PERFORMANCE", trend: "Performance Trend", last7: "Last 7 Days", last30: "Last 30 Days", last90: "Last 90 Days", training: "TRAINING", schedule: "Today's Schedule", viewAll: "View All", activity: "ACTIVITY", recent: "Recent Activity", viewActivity: "View All Activity →",
  ...
  ja: {
    ...
    insight: "AIインサイト", performanceLabel: "パフォーマンス", trend: "パフォーマンス推移", last7: "過去7日", last30: "過去30日", last90: "過去90日", training: "トレーニング", schedule: "本日の予定", viewAll: "すべて表示", activity: "アクティビティ", recent: "最近の活動", viewActivity: "すべての活動を見る →",
